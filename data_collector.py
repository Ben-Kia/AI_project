...
embedding_function = HuggingFaceBgeEmbeddings(
    ...
    model_kwargs={'device': 'cpu'}, # works with CUDA, too, but requires CUDA-enabled torch
...
document_content_description = "cell performance" # do we need this argument? if so make it more specific.
